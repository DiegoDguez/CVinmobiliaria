...
<body>
    ...
    <div class="portto-container">
        ...
        <div class="header-pb">
            <h1 class="header-heading vl-teal-text futura-light">EL ESTILO DE VIDA <br>QUE ESPERABAS</h1>
            <div class="header-img">
                <img src="media/assets/img/habitta/veredas-lira/veredas-lira.jpg">
            </div>
        </div>
    ...
    <div class="py">
        <h2 class="headline-2 center-align vl-darkteal-text futura-light">Lotes residenciales diseñados para las necesidades de nuestros clientes más exigentes</h2>
        <div class="row center py">
            <div class="col s12">
                <img class="plano-lote" src="media/assets/img/habitta/veredas-lira/lotes/lotes-abc.svg">
            </div>
        </div>
    </div>
