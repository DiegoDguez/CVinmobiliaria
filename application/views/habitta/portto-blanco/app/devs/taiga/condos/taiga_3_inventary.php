...
<body ng-controller="PBTaigaCtrl as taiga">
		...
		<div class="container__panel">
			...
			<div class="content__panel">
				<ul class="saufth-collapsable">
					<li ng-repeat="property in taiga.inmovablesData.inmovables" ng-if="property.idCondominium === 19">
	...
	<div class="plano_container">
		...
		<svg version="1.1" class="quote__map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			...
			<g>
				<g>
					<g class="property__active" ng-class="taiga.inmovablesClassList[187]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[187])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[188]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[188])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[189]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[189])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[190]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[190])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[191]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[191])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[192]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[192])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[193]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[193])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[194]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[194])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[195]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[195])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[196]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[196])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[197]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[197])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[198]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[198])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[199]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[199])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[200]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[200])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[201]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[201])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[202]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[202])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[203]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[203])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[204]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[204])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[205]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[205])">
					...
					<g id="class="property__active" ng-class="taiga.inmovablesClassList[206]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[206])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[207]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[207])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[208]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[208])">
			...
			"/>
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[209]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[209])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[210]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[210])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[211]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[211])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[212]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[212])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[213]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[213])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[214]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[214])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[215]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[215])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[216]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[216])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[217]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[217])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[218]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[218])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[219]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[219])">
					...
					<g class="property__active" ng-class="taiga.inmovablesClassList[220]" ng-click="taiga.setLeadProperty(taiga.inmovablesData.inmovables[220])">
