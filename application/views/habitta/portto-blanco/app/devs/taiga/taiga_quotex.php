	...
	<div class="plano_container">
		...
		<svg version="1.1" class="quote__map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1366 720" style="enable-background:new 0 0 1366 720;" xml:space="preserve">
			...
			<g>
				...
				<g>
					<path class="blue__fill" d="M444.9,568.4l-2.2-1.6c-0.5,0.5-1.1,0.6-1.7,0.4c-0.7-0.3-1.1-1.2-0.7-2.1c-0.7-0.5-1.3-0.9-2-1.4l1.3,5.5
						L444.9,568.4z"/>
					<text transform="matrix(-0.8057 -0.5923 0.5923 -0.8057 446.7319 565.5868)" class="blue0__fill futura-book fs__2-6__px">SALIDA</text>
				</g>
				<g>
					<path class="blue__fill" d="M464.7,581.2l2.3,1.4c0.4-0.5,1.1-0.7,1.6-0.5c0.7,0.2,1.2,1.2,0.9,2c0.7,0.4,1.4,0.8,2.1,1.3l-1.7-5.4
						L464.7,581.2z"/>
					<text transform="matrix(0.8494 0.5278 -0.5278 0.8494 463.0627 584.1442)" class="blue0__fill futura-book fs__2-6__px">ACCESO</text>
				</g>
				<g>
					<path class="blue__fill" d="M844.6,186.8l0.5,2.7c0.7,0,1.3,0.3,1.5,0.9c0.3,0.7-0.1,1.6-1,2c0.1,0.8,0.3,1.6,0.4,2.4l2.9-4.9
						L844.6,186.8z"/>
					<text transform="matrix(0.1699 0.9855 -0.9855 0.1699 841.362 187.5444)" class="blue0__fill futura-book fs__2-6__px">SALIDA</text>
				</g>
				<g>
					<path class="blue__fill" d="M839.2,163.9l-0.7-2.6c-0.7,0.1-1.3-0.2-1.6-0.7c-0.4-0.7,0-1.7,0.8-2.1c-0.2-0.8-0.4-1.6-0.6-2.4l-2.5,5.1
						L839.2,163.9z"/>
					<text transform="matrix(-0.2461 -0.9692 0.9692 -0.2461 842.5046 162.8914)" class="blue0__fill futura-book fs__2-6__px">ACCESO</text>
				</g>
				<g>
					<path class="blue__fill" d="M924.4,145.4l-0.5-2.7c-0.7,0-1.3-0.3-1.5-0.8c-0.3-0.7,0.1-1.7,0.9-2c-0.2-0.8-0.3-1.6-0.5-2.4l-2.8,4.9
						L924.4,145.4z"/>
					<text transform="matrix(-0.1886 -0.9821 0.9821 -0.1886 927.6318 144.5728)" class="blue0__fill futura-book fs__2-6__px">SALIDA</text>
				</g>
				<g>
					<path class="blue__fill" d="M930.2,168.2l0.8,2.6c0.7-0.1,1.3,0.2,1.6,0.7c0.4,0.7,0.1,1.6-0.8,2.1c0.2,0.8,0.5,1.6,0.7,2.3l2.4-5.1
						L930.2,168.2z"/>
					<text transform="matrix(0.2645 0.9644 -0.9644 0.2645 926.9937 169.2346)" class="blue0__fill futura-book fs__2-6__px">ACCESO</text>
				</g>
				<path class="blue__fill" d="M455.4,573.7l-0.2-0.1h-0.8l-0.2-0.7l-0.2-0.1l0.4-0.5l0.1-0.1c0.1,0,0.1,0,0.2,0s0.2,0,0.4,0
					c0.2,0,0.4,0,0.5,0c0.1,0.1,0.1,0.2,0.2,0.4s0.1,0.3,0.1,0.4v0.1c0,0.1,0,0.1-0.1,0.1C455.7,573.3,455.5,573.5,455.4,573.7z"/>
				
					<rect x="455.8" y="569.5" transform="matrix(0.5965 -0.8026 0.8026 0.5965 -274.7566 596.6208)" class="blue__fill" width="0.4" height="4.1"/>
				...
				<path class="blue__fill" d="M840.6,176.3v-0.2l-0.5-0.5l0.3-0.7v-0.2l0.6-0.1c0,0,0.1,0,0.2,0c0.1,0,0.1,0,0.1,0.1c0.1,0,0.2,0.1,0.3,0.2
					...
					<rect x="842.3" y="173" transform="matrix(0.9818 -0.1898 0.1898 0.9818 -17.9127 163.087)" class="blue__fill" width="0.4" height="4.1"/>
				...
				<path class="blue__fill" d="M928.7,156.6v0.2l0.5,0.5l-0.3,0.7v0.2l-0.6,0.1c0,0-0.1,0-0.2,0c-0.1,0-0.1,0-0.1-0.1
					...
					<rect x="926.6" y="155.8" transform="matrix(0.9818 -0.1898 0.1898 0.9818 -13.1157 178.7771)" class="blue__fill" width="0.4" height="4.1"/>
			</g>
			...
			<g>
				<a href="#!/Portto_Blanco-Taiga_1" class="pb__condo">
				...
				<a href="#!/Portto_Blanco-Taiga_2" class="pb__condo">
				...
				<a href="#!/Portto_Blanco-Taiga_3" class="pb__condo">
