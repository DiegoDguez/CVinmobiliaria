...
<body ng-controller="PBDesierto1QuoteCtrl as desierto">
	...
	<div class="plano_container">
		...
		<svg class="quote__map" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			...
			<g>
				<g>
					<polygon class="property pb-sprite-1" points="725,300.1 869,238.6 869.5,237.2 850,191.9 705.1,253.8" ng-class="desierto.inmovablesClassList[181]" ng-click="desierto.showPropertyData(11, '1')"/>
					<polygon class="property pb-sprite-2" points="685.4,207.5 830.2,145.6 850,191.9 705.1,253.8" ng-class="desierto.inmovablesClassList[182]" ng-click="desierto.showPropertyData(11, '2')"/>
					<polygon class="property pb-sprite-1" points="665.5,161 685.4,207.5 830.2,145.6 810.4,99.2" ng-class="desierto.inmovablesClassList[183]" ng-click="desierto.showPropertyData(11, '3')"/>
					<polygon class="property pb-sprite-2" points="665.5,161 810.4,99.2 790.7,52.6 645.8,114.7" ng-class="desierto.inmovablesClassList[184]" ng-click="desierto.showPropertyData(11, '4')"/>
				</g>
				<g>
					<polygon class="property pb-sprite-1" points="428.4,94.6 539.9,266.6 592.7,232.2 491.3,75.7 462.2,83.4 447,87.9" ng-class="desierto.inmovablesClassList[185]" ng-click="desierto.showPropertyData(11, '5')"/>
					<polygon class="property pb-sprite-2" points="372.1,123.7 386.7,114.7 399.1,107.8 408.6,103.1 428.4,94.6 539.9,266.6 486.9,300.9" ng-class="desierto.inmovablesClassList[186]" ng-click="desierto.showPropertyData(11, '6')"/>
					<polygon class="property pb-sprite-1" points="319.4,157.9 372.1,123.7 486.9,300.9 434,335" ng-class="desierto.inmovablesClassList[187]" ng-click="desierto.showPropertyData(11, '7')"/>
					<polygon class="property pb-sprite-2" points="319.4,157.9 434,335 381.1,369.4 266.4,192.2" ng-class="desierto.inmovablesClassList[188]" ng-click="desierto.showPropertyData(11, '8')"/>
					<polygon class="property pb-sprite-1" points="213.4,226.5 266.4,192.2 381.1,369.4 328.2,403.7" ng-class="desierto.inmovablesClassList[189]" ng-click="desierto.showPropertyData(11, '9')"/>
					<polygon class="property pb-sprite-2" points="160.5,260.8 213.4,226.5 328.2,403.7 275.2,438" ng-class="desierto.inmovablesClassList[190]" ng-click="desierto.showPropertyData(11, '10')"/>
					<polygon class="property pb-sprite-1" points="107.7,295.1 160.5,260.8 275.2,438 222.4,472.1" ng-class="desierto.inmovablesClassList[191]" ng-click="desierto.showPropertyData(11, '11')"/>
					<polygon class="property pb-sprite-2" points="54.7,329.3 107.7,295.1 222.4,472.1 169.3,506.6" ng-class="desierto.inmovablesClassList[192]" ng-click="desierto.showPropertyData(11, '12')"/>
					<polygon class="property pb-sprite-1" points="1.8,363.5 54.7,329.3 169.3,506.6 116.7,540.7" ng-class="desierto.inmovablesClassList[193]" ng-click="desierto.showPropertyData(11, '13')"/>
				</g>
				<g>
					<polygon class="property pb-sprite-2" points="148.6,589.8 176,632.3 308.2,546.8 280.8,504.6" ng-class="desierto.inmovablesClassList[194]" ng-click="desierto.showPropertyData(11, '14')"/>
					<polygon class="property pb-sprite-1" points="176,632.3 308.2,546.8 335.5,589 203.4,674.6" ng-class="desierto.inmovablesClassList[195]" ng-click="desierto.showPropertyData(11, '15')"/>
					<polygon class="property pb-sprite-2" points="203.4,674.6 335.5,589 363.1,631.5 230.9,717" ng-class="desierto.inmovablesClassList[196]" ng-click="desierto.showPropertyData(11, '16')"/>
					<polygon class="property pb-sprite-1" points="230.9,717 363.1,631.5 390.4,673.6 258.4,759.3" ng-class="desierto.inmovablesClassList[197]" ng-click="desierto.showPropertyData(11, '17')"/>
					<polygon class="property pb-sprite-2" points="258.4,759.3 390.4,673.6 417.9,716.1 285.7,801.6" ng-class="desierto.inmovablesClassList[198]" ng-click="desierto.showPropertyData(11, '18')"/>
					<polygon class="property pb-sprite-1" points="285.7,801.6 417.9,716.1 445.3,758.3 313.2,843.9" ng-class="desierto.inmovablesClassList[199]" ng-click="desierto.showPropertyData(11, '19')"/>
					<polygon class="property pb-sprite-2" points="313.2,843.9 445.3,758.3 472.7,800.7 340.4,886.4" ng-class="desierto.inmovablesClassList[200]" ng-click="desierto.showPropertyData(11, '20')"/>
					<polygon class="property pb-sprite-1" points="340.4,886.4 472.7,800.7 500.3,842.8 368.1,928.6" ng-class="desierto.inmovablesClassList[201]" ng-click="desierto.showPropertyData(11, '21')"/>
					<polygon class="property pb-sprite-2" points="368.1,928.6 500.3,842.8 527.5,885.3 395.4,971" ng-class="desierto.inmovablesClassList[202]" ng-click="desierto.showPropertyData(11, '22')"/>
					<polygon class="property pb-sprite-1" points="395.4,971 527.5,885.3 555,927.6 422.7,1013.2" ng-class="desierto.inmovablesClassList[203]" ng-click="desierto.showPropertyData(11, '23')"/>
					<polygon class="property pb-sprite-2" points="555,927.6 582.4,970 450.3,1055.6 422.7,1013.2" ng-class="desierto.inmovablesClassList[204]" ng-click="desierto.showPropertyData(11, '24')"/>
					<polygon class="property pb-sprite-1" points="450.3,1055.6 582.4,970 609.8,1012.2 477.8,1097.8" ng-class="desierto.inmovablesClassList[205]" ng-click="desierto.showPropertyData(11, '25')"/>
					<polygon class="property pb-sprite-2" points="477.8,1097.8 505,1140.3 637.3,1054.7 609.8,1012.2" ng-class="desierto.inmovablesClassList[206]" ng-click="desierto.showPropertyData(11, '26')"/>
					<polygon class="property pb-sprite-1" points="505,1140.3 637.3,1054.7 664.8,1096.9 532.6,1182.6" ng-class="desierto.inmovablesClassList[207]" ng-click="desierto.showPropertyData(11, '27')"/>
					<polygon class="property pb-sprite-2" points="532.6,1182.6 664.8,1096.9 692,1139.2 560,1224.8" ng-class="desierto.inmovablesClassList[208]" ng-click="desierto.showPropertyData(11, '28')"/>
					<polygon class="property pb-sprite-1" points="692,1139.2 719.6,1181.6 587.5,1267.3 560,1224.8" ng-class="desierto.inmovablesClassList[209]" ng-click="desierto.showPropertyData(11, '29')"/>
					<polygon class="property pb-sprite-2" points="587.5,1267.3 719.6,1181.6 747,1223.9 614.8,1309.5" ng-class="desierto.inmovablesClassList[210]" ng-click="desierto.showPropertyData(11, '30')"/>
					<polygon class="property pb-sprite-1" points="614.8,1309.5 747,1223.9 774.5,1266.2 642.5,1351.7" ng-class="desierto.inmovablesClassList[211]" ng-click="desierto.showPropertyData(11, '31')"/>
					<polygon class="property pb-sprite-2" points="642.5,1351.7 774.5,1266.2 801.9,1308.6 669.9,1394.4" ng-class="desierto.inmovablesClassList[212]" ng-click="desierto.showPropertyData(11, '32')"/>
					<polygon class="property pb-sprite-1" points="669.9,1394.4 801.9,1308.6 834.5,1358.8 702.2,1444.6" ng-class="desierto.inmovablesClassList[213]" ng-click="desierto.showPropertyData(11, '33')"/>
					<polygon class="property pb-sprite-2" points="702.2,1444.6 834.5,1358.8 866.9,1409.1 734.8,1494.8" ng-class="desierto.inmovablesClassList[214]" ng-click="desierto.showPropertyData(11, '34')"/>
				</g>
				<g>
					<polygon class="property pb-sprite-1" points="844.7,1267.3 926.1,1392.2 977.6,1344.5 903,1229.4" ng-class="desierto.inmovablesClassList[215]" ng-click="desierto.showPropertyData(11, '35')"/>
					<polygon class="property pb-sprite-2" points="903,1229.4 950.8,1198.4 1034.2,1327.4 987.3,1335.7 977.6,1344.5" ng-class="desierto.inmovablesClassList[216]" ng-click="desierto.showPropertyData(11, '36')"/>
					<polygon class="property pb-sprite-1" points="950.8,1198.4 998.1,1167.7 1094.8,1316.6 1034.2,1327.4" ng-class="desierto.inmovablesClassList[217]" ng-click="desierto.showPropertyData(11, '37')"/>
					<polygon class="property pb-sprite-2" points="998.1,1167.7 1045.9,1136.8 1155.7,1306.1 1094.8,1316.6" ng-class="desierto.inmovablesClassList[218]" ng-click="desierto.showPropertyData(11, '38')"/>
				</g>
				<g>
					<polygon class="property pb-sprite-1" points="1192.4,1242.9 1337.5,1180.9 1361.7,1238.4 1212,1289.3" ng-class="desierto.inmovablesClassList[219]" ng-click="desierto.showPropertyData(11, '39')"/>
					<polygon class="property pb-sprite-2" points="1172.6,1196.3 1192.4,1242.9 1337.5,1180.9 1317.5,1134.5" ng-class="desierto.inmovablesClassList[220]" ng-click="desierto.showPropertyData(11, '40')"/>
					<polygon class="property pb-sprite-1" points="1152.8,1150 1297.7,1088.2 1317.5,1134.5 1172.6,1196.3" ng-class="desierto.inmovablesClassList[221]" ng-click="desierto.showPropertyData(11, '41')"/>
					<polygon class="property pb-sprite-2" points="1152.8,1150 1297.7,1088.2 1277.8,1041.7 1133.2,1103.7" ng-class="desierto.inmovablesClassList[222]" ng-click="desierto.showPropertyData(11, '42')"/>
					<polygon class="property pb-sprite-1" points="1113.2,1057.2 1258.1,995.5 1277.8,1041.7 1133.2,1103.7" ng-class="desierto.inmovablesClassList[223]" ng-click="desierto.showPropertyData(11, '43')"/>
					<polygon class="property pb-sprite-2" points="1113.2,1057.2 1258.1,995.5 1238.3,949.1 1093.2,1010.9" ng-class="desierto.inmovablesClassList[224]" ng-click="desierto.showPropertyData(11, '44')"/>
					<polygon class="property pb-sprite-1" points="1073.7,964.5 1218.6,902.6 1238.3,949.1 1093.2,1010.9" ng-class="desierto.inmovablesClassList[225]" ng-click="desierto.showPropertyData(11, '45')"/>
					<polygon class="property pb-sprite-2" points="1073.7,964.5 1218.6,902.6 1198.7,856.2 1053.8,918.2" ng-class="desierto.inmovablesClassList[226]" ng-click="desierto.showPropertyData(11, '46')"/>
					<polygon class="property pb-sprite-1" points="1034.1,871.8 1178.9,809.9 1198.7,856.2 1053.8,918.2" ng-class="desierto.inmovablesClassList[227]" ng-click="desierto.showPropertyData(11, '47')"/>
					<polygon class="property pb-sprite-2" points="1034.1,871.8 1178.9,809.9 1159.1,763.5 1014.2,825.5" ng-class="desierto.inmovablesClassList[228]" ng-click="desierto.showPropertyData(11, '48')"/>
					<polygon class="property pb-sprite-1" points="994.4,778.9 1139.4,717.1 1159.1,763.5 1014.2,825.5" ng-class="desierto.inmovablesClassList[229]" ng-click="desierto.showPropertyData(11, '49')"/>
					<polygon class="property pb-sprite-2" points="994.4,778.9 1139.4,717.1 1119.4,670.6 974.6,732.5" ng-class="desierto.inmovablesClassList[230]" ng-click="desierto.showPropertyData(11, '50')"/>
					<polygon class="property pb-sprite-1" points="955,686.2 1099.7,624.2 1119.4,670.6 974.6,732.5" ng-class="desierto.inmovablesClassList[231]" ng-click="desierto.showPropertyData(11, '51')"/>
					<polygon class="property pb-sprite-2" points="955,686.2 1099.7,624.2 1079.8,577.8 935.1,639.9" ng-class="desierto.inmovablesClassList[232]" ng-click="desierto.showPropertyData(11, '52')"/>
					<polygon class="property pb-sprite-1" points="915.2,593.5 1060.1,531.5 1079.8,577.8 935.1,639.9" ng-class="desierto.inmovablesClassList[233]" ng-click="desierto.showPropertyData(11, '53')"/>
					<polygon class="property pb-sprite-2" points="915.2,593.5 1060.1,531.5 1040.3,485.2 895.5,547" ng-class="desierto.inmovablesClassList[234]" ng-click="desierto.showPropertyData(11, '54')"/>
					<polygon class="property pb-sprite-1" points="875.7,500.5 1020.4,438.8 1040.3,485.2 895.5,547" ng-class="desierto.inmovablesClassList[235]" ng-click="desierto.showPropertyData(11, '55')"/>
					<polygon class="property pb-sprite-2" points="875.7,500.5 1020.4,438.8 1000.7,392.4 855.9,454.1" ng-class="desierto.inmovablesClassList[236]" ng-click="desierto.showPropertyData(11, '56')"/>
				</g>
				<g>
					<polygon class="property pb-sprite-2" points="667.1,528.8 720,494.5 834.7,671.7 781.8,706" ng-class="desierto.inmovablesClassList[237]" ng-click="desierto.showPropertyData(11, '57')"/>
					<polygon class="property pb-sprite-1" points="729,740.2 781.8,706 667.1,528.8 614.2,563.1" ng-class="desierto.inmovablesClassList[238]" ng-click="desierto.showPropertyData(11, '58')"/>
					<polygon class="property pb-sprite-2" points="561.2,597.4 614.2,563.1 729,740.2 675.9,774.6" ng-class="desierto.inmovablesClassList[239]" ng-click="desierto.showPropertyData(11, '59')"/>
					<polygon class="property pb-sprite-1" points="508.5,631.9 561.2,597.4 675.9,774.6 623.2,809" ng-class="desierto.inmovablesClassList[240]" ng-click="desierto.showPropertyData(11, '60')"/>
					<polygon class="property pb-sprite-2" points="455.6,665.9 508.5,631.9 623.2,809 570.3,843.1" ng-class="desierto.inmovablesClassList[241]" ng-click="desierto.showPropertyData(11, '61')"/>
				</g>
				<g>
					<polygon class="property pb-sprite-1" points="602.3,892.4 655,858.1 769.8,1035.3 717,1069.6" ng-class="desierto.inmovablesClassList[242]" ng-click="desierto.showPropertyData(11, '62')"/>
					<polygon class="property pb-sprite-2" points="655,858.1 708,823.8 822.7,1001 769.8,1035.3" ng-class="desierto.inmovablesClassList[243]" ng-click="desierto.showPropertyData(11, '63')"/>
					<polygon class="property pb-sprite-1" points="708,823.8 760.8,789.6 875.5,966.6 822.7,1001" ng-class="desierto.inmovablesClassList[244]" ng-click="desierto.showPropertyData(11, '64')"/>
					<polygon class="property pb-sprite-2" points="875.5,966.6 928.5,932.4 813.7,755.3 760.8,789.6" ng-class="desierto.inmovablesClassList[245]" ng-click="desierto.showPropertyData(11, '65')"/>
					<polygon class="property pb-sprite-1" points="867.1,721.1 813.7,755.3 928.5,932.4 981.7,897.8" ng-class="desierto.inmovablesClassList[246]" ng-click="desierto.showPropertyData(11, '66')"/>
					<polygon class="property pb-sprite-2" points="1003.4,1094.3 907.4,946 955.1,915.4 1051.1,1063.8" ng-class="desierto.inmovablesClassList[247]" ng-click="desierto.showPropertyData(11, '67')"/>
					<polygon class="property pb-sprite-1" points="859.8,977.1 907.4,946 1003.4,1094.3 955.8,1125.1" ng-class="desierto.inmovablesClassList[248]" ng-click="desierto.showPropertyData(11, '68')"/>
					<polygon class="property pb-sprite-2" points="908.3,1156.1 812.1,1007.9 859.8,977.1 955.8,1125.1" ng-class="desierto.inmovablesClassList[249]" ng-click="desierto.showPropertyData(11, '69')"/>
					<polygon class="property pb-sprite-1" points="812.1,1007.9 764.7,1038.8 860.8,1187 908.3,1156.1" ng-class="desierto.inmovablesClassList[250]" ng-click="desierto.showPropertyData(11, '70')"/>
					<polygon class="property pb-sprite-2" points="717,1069.6 764.7,1038.8 860.8,1187 812.9,1217.7" ng-class="desierto.inmovablesClassList[251]" ng-click="desierto.showPropertyData(11, '71')"/>
				</g>
