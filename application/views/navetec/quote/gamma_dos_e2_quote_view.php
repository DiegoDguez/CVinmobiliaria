...
<body ng-controller="NvtGammaDosQuoteCtrl as nvtGammaDos">
	...
	<div class="modal-dialog" ng-class="nvtGammaDos.dialogDisplay">
		...
		<div class="container-dialog p-20">
			...
			<div class="content-dialog">
                ...
                <div class="p-20">
                    <h6 class="deep-purple-text futura-light">{{nvtGammaDos.propertyData.discountPlan2}}% de descuento para propiedades con financiamiento hasta 10 años</h6>
                    ...
                    <p class="promo__description grey-text">Entrega a 15 meses</p>
                    <p class="promo__description grey-text">¡Oferta limitada!</p>
                </div> -->
	...
	<div class="plano_container">
        ...
        <g id="ISLA_G_1_">
            ...
            <g>
                <rect id="G_N03_1_" x="950.5" y="656.7" class="st0" width="66.4" height="186.5"/>
            ...
            <g>
                <rect id="G_N04_1_" x="883.9" y="656.7" class="st10" width="66.7" height="186.5"/>
            ...
            <g>
                <rect id="G_N05_1_" x="817.4" y="656.7" class="st0" width="66.4" height="186.5"/>
            ...
            <g>
                <rect id="G_N06_1_" x="750.8" y="656.7" class="st10" width="66.6" height="186.5"/>
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[0]" ng-click="nvtGammaDos.showPropertyData(31, '8G', nvtGammaDos.inmovables[0].idProperty)" >
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[8]" ng-click="nvtGammaDos.showPropertyData(31, '9G', nvtGammaDos.inmovables[8].idProperty)">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[9]" ng-click="nvtGammaDos.showPropertyData(31, '10G', nvtGammaDos.inmovables[9].idProperty)">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[10]" ng-click="nvtGammaDos.showPropertyData(31, '11G', nvtGammaDos.inmovables[10].idProperty)">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[11]" ng-click="nvtGammaDos.showPropertyData(31, '12G', nvtGammaDos.inmovables[11].idProperty)">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[13]" ng-click="nvtGammaDos.showPropertyData(31, '13G', nvtGammaDos.inmovables[12].idProperty)">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[13]" ng-click="nvtGammaDos.showPropertyData(31, '14G', nvtGammaDos.inmovables[13].idProperty)">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[14]" ng-click="nvtGammaDos.showPropertyData(31, '15G', nvtGammaDos.inmovables[14].idProperty)">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[15]" ng-click="nvtGammaDos.showPropertyData(31, '16G', nvtGammaDos.inmovables[15].idProperty)">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[16]" ng-click="nvtGammaDos.showPropertyData(31, '17G', nvtGammaDos.inmovables[16].idProperty)">
        ...
        <g id="ISLA_H_1_">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[23]" ng-click="nvtGammaDos.showPropertyData(31, '7H', nvtGammaDos.inmovables[23].idProperty)">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[24]" ng-click="nvtGammaDos.showPropertyData(31, '8H', nvtGammaDos.inmovables[24].idProperty)" >
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[25]" ng-click="nvtGammaDos.showPropertyData(31, '9H', nvtGammaDos.inmovables[25].idProperty)">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[26]" ng-click="nvtGammaDos.showPropertyData(31, '10H', nvtGammaDos.inmovables[26].idProperty)">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[27]" ng-click="nvtGammaDos.showPropertyData(31, '11H', nvtGammaDos.inmovables[27].idProperty)">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[28]" ng-click="nvtGammaDos.showPropertyData(31, '12H', nvtGammaDos.inmovables[28].idProperty)">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[29]" ng-click="nvtGammaDos.showPropertyData(31, '13H', nvtGammaDos.inmovables[29].idProperty)">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[30]" ng-click="nvtGammaDos.showPropertyData(31, '14H', nvtGammaDos.inmovables[30].idProperty)">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[31]" ng-click="nvtGammaDos.showPropertyData(31, '15H', nvtGammaDos.inmovables[31].idProperty)">
            ...
            <g ng-class="nvtGammaDos.inmovablesClassList[32]" ng-click="nvtGammaDos.showPropertyData(31, '16H', nvtGammaDos.inmovables[32].idProperty)">
        ...
        <a href="#!/Navetec-Gamma_II_E1_Business_Park" class="pb__condo">
            <g>
                <polygon class="st0" points="1182.3,172.7 1115.8,169.7 1108.3,382.3 699.5,382.3 699.5,575.8 683.8,656.5 683.8,843 1104.2,843.1 
                    1156.6,845.2 	"/>
                <g>
                    <text transform="matrix(1 0 0 1 817.6523 618.7041)"><tspan x="0" y="0" class="st1 futura-book st6 st4">ETAPA I</tspan><tspan x="32.2" y="22.3" class="st1 futura-book st7">9 MESES</tspan></text>
                </g>
            </g>
        </a>
