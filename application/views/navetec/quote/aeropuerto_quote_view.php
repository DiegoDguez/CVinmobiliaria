		...
		<div class="container-dialog p-20">
			...
			<div class="content-dialog">
				...
				<div class="p-20 grey lighten-5">
					<div class="p-5">
						<h6 class="futura-med">Navetec Business Park {{nvtAeropuerto.propertyData.condominium}}</h6>
					</div>
					<div class="p-5">
						<h6 class="futura-light">{{nvtAeropuerto.propertyData.propertyClass}}</h6>
					</div>
					<div class="p-5">
						<h6 class="futura-light">{{nvtAeropuerto.propertyData.type}}</h6>
					</div>
					<div class="p-5">
						<h6 class="futura-light">Número {{nvtAeropuerto.propertyData.number}}</h6>
					</div>
					<!-- <div class="p-5">
						<h6 class="futura-light">Dimenciones: {{nvtAeropuerto.propertyData.dimensions}}</h6>
					</div> -->
					<div class="p-5">
						<h6 class="futura-light">Área de {{nvtAeropuerto.propertyData.area}} M&sup2;</h6>
					</div>
					<div class="p-5">
						<h6 class="futura-light">Precio por M&sup2; de ${{nvtAeropuerto.property.sample.m2.toLocaleString(undefined, {minimumFractionDigits: 2,'maximumFractionDigits':2}) }} MXN</h6>
					</div>
					<div class="p-5">
						<h6 class="futura-light green-text">Precio de ${{nvtAeropuerto.property.sample.property.toLocaleString(undefined, {minimumFractionDigits: 2,'maximumFractionDigits':2}) }} MXN <span style="color: #857C82; font-size: 12px;">{{ (nvtAeropuerto.propertyData.propertyClass !== 'Lote industrial') ? '+ I.V.A.' : '' }}</span></h6>
					</div>
					<div class="p-5">
				...
				<div class="p-20">
					<h6 class="deep-purple-text futura-light">{{nvtAeropuerto.propertyData.discountPlan1}}% para propiedades pagadas de contado al 100%</h6>
					<h6 class="green-text futura-light">Precio de ${{ nvtAeropuerto.property.sample.discount1.toLocaleString(undefined, {minimumFractionDigits: 2,'maximumFractionDigits':2}) }} MXN <span style="color: #857C82; font-size: 12px;">+ I.V.A.</span></h6>
				...
				<div class="p-20">
					<h6 class="deep-purple-text futura-light">{{nvtAeropuerto.propertyData.discountPlan2}}% de descuento para propiedades con financiamiento hasta 10 años</h6>
					<h6 class="green-text futura-light">Precio de ${{ nvtAeropuerto.property.sample.discount2.toLocaleString(undefined, {minimumFractionDigits: 2,'maximumFractionDigits':2}) }} MXN <span style="color: #857C82; font-size: 12px;">+ I.V.A.</span></h6>
					<p class="promo__description grey-text">¡Oferta limitada!</p>
				</div> -->
				...
				<div class="p-20">
					...
					<p class="green-text">Con tan solo {{nvtAeropuerto.costToBlock}}</p>
	...
	<div class="plano_container">
		...
		<div class="container mt-64">
			<div class="row quote-header">
				<div class="col s12">
					<h2 class="center-align futura-med">AEROPUERTO</h2>
		...
		<svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			...
			<g id="islas_aeropuerto">
				<g id="isla_a">
					<g ng-class="nvtAeropuerto.inmovablesClassList[0]" ng-click="nvtAeropuerto.showPropertyData(6, '1A', nvtAeropuerto.inmovables[0].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[1]" ng-click="nvtAeropuerto.showPropertyData(6, '2A', nvtAeropuerto.inmovables[1].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[2]" ng-click="nvtAeropuerto.showPropertyData(6, '3A', nvtAeropuerto.inmovables[2].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[3]" ng-click="nvtAeropuerto.showPropertyData(6, '4A', nvtAeropuerto.inmovables[3].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[4]" ng-click="nvtAeropuerto.showPropertyData(6, '5A', nvtAeropuerto.inmovables[4].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[5]" ng-click="nvtAeropuerto.showPropertyData(6, '6A', nvtAeropuerto.inmovables[5].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[6]" ng-click="nvtAeropuerto.showPropertyData(6, '7A', nvtAeropuerto.inmovables[6].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[7]" ng-click="nvtAeropuerto.showPropertyData(6, '8A', nvtAeropuerto.inmovables[7].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[8]" ng-click="nvtAeropuerto.showPropertyData(6, '9A', nvtAeropuerto.inmovables[8].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[9]" ng-click="nvtAeropuerto.showPropertyData(6, '10A', nvtAeropuerto.inmovables[9].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[10]" ng-click="nvtAeropuerto.showPropertyData(6, '11A', nvtAeropuerto.inmovables[10].idProperty)">
				...
				<g id="isla_b">
					<g ng-class="nvtAeropuerto.inmovablesClassList[11]" ng-click="nvtAeropuerto.showPropertyData(6, '1B', nvtAeropuerto.inmovables[11].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[12]" ng-click="nvtAeropuerto.showPropertyData(6, '2B', nvtAeropuerto.inmovables[12].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[13]" ng-click="nvtAeropuerto.showPropertyData(6, '3B', nvtAeropuerto.inmovables[13].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[14]" ng-click="nvtAeropuerto.showPropertyData(6, '4B', nvtAeropuerto.inmovables[14].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[15]" ng-click="nvtAeropuerto.showPropertyData(6, '5B', nvtAeropuerto.inmovables[15].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[16]" ng-click="nvtAeropuerto.showPropertyData(6, '6B', nvtAeropuerto.inmovables[16].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[17]" ng-click="nvtAeropuerto.showPropertyData(6, '7B', nvtAeropuerto.inmovables[17].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[18]" ng-click="nvtAeropuerto.showPropertyData(6, '8B', nvtAeropuerto.inmovables[18].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[19]" ng-click="nvtAeropuerto.showPropertyData(6, '9B', nvtAeropuerto.inmovables[19].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[20]" ng-click="nvtAeropuerto.showPropertyData(6, '10B', nvtAeropuerto.inmovables[20].idProperty)">
				...
				<g id="isla_c">
					<g ng-class="nvtAeropuerto.inmovablesClassList[21]" ng-click="nvtAeropuerto.showPropertyData(6, '1C', nvtAeropuerto.inmovables[21].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[22]" ng-click="nvtAeropuerto.showPropertyData(6, '2C', nvtAeropuerto.inmovables[22].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[23]" ng-click="nvtAeropuerto.showPropertyData(6, '3C', nvtAeropuerto.inmovables[23].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[24]" ng-click="nvtAeropuerto.showPropertyData(6, '4C', nvtAeropuerto.inmovables[24].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[25]" ng-click="nvtAeropuerto.showPropertyData(6, '5C', nvtAeropuerto.inmovables[25].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[26]" ng-click="nvtAeropuerto.showPropertyData(6, '6C', nvtAeropuerto.inmovables[26].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[27]" ng-click="nvtAeropuerto.showPropertyData(6, '7C', nvtAeropuerto.inmovables[27].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[28]" ng-click="nvtAeropuerto.showPropertyData(6, '8C', nvtAeropuerto.inmovables[28].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[29]" ng-click="nvtAeropuerto.showPropertyData(6, '9C', nvtAeropuerto.inmovables[29].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[30]" ng-click="nvtAeropuerto.showPropertyData(6, '10C', nvtAeropuerto.inmovables[30].idProperty)">
				...
				<g id="isla_d">
					<g ng-class="nvtAeropuerto.inmovablesClassList[31]" ng-click="nvtAeropuerto.showPropertyData(6, '1D', nvtAeropuerto.inmovables[31].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[32]" ng-click="nvtAeropuerto.showPropertyData(6, '2D', nvtAeropuerto.inmovables[32].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[33]" ng-click="nvtAeropuerto.showPropertyData(6, '3D', nvtAeropuerto.inmovables[33].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[34]" ng-click="nvtAeropuerto.showPropertyData(6, '4D', nvtAeropuerto.inmovables[34].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[35]" ng-click="nvtAeropuerto.showPropertyData(6, '5D', nvtAeropuerto.inmovables[35].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[36]" ng-click="nvtAeropuerto.showPropertyData(6, '6D', nvtAeropuerto.inmovables[36].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[37]" ng-click="nvtAeropuerto.showPropertyData(6, '7D', nvtAeropuerto.inmovables[37].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[38]" ng-click="nvtAeropuerto.showPropertyData(6, '8D', nvtAeropuerto.inmovables[38].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[39]" ng-click="nvtAeropuerto.showPropertyData(6, '9D', nvtAeropuerto.inmovables[39].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[40]" ng-click="nvtAeropuerto.showPropertyData(6, '10D', nvtAeropuerto.inmovables[40].idProperty)">
				...
				<g id="isla_e">
					<g ng-class="nvtAeropuerto.inmovablesClassList[41]" ng-click="nvtAeropuerto.showPropertyData(6, '1E', nvtAeropuerto.inmovables[41].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[42]" ng-click="nvtAeropuerto.showPropertyData(6, '2E', nvtAeropuerto.inmovables[42].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[43]" ng-click="nvtAeropuerto.showPropertyData(6, '3E', nvtAeropuerto.inmovables[43].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[44]" ng-click="nvtAeropuerto.showPropertyData(6, '4E', nvtAeropuerto.inmovables[44].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[45]" ng-click="nvtAeropuerto.showPropertyData(6, '5E', nvtAeropuerto.inmovables[45].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[46]" ng-click="nvtAeropuerto.showPropertyData(6, '6E', nvtAeropuerto.inmovables[46].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[47]" ng-click="nvtAeropuerto.showPropertyData(6, '7E', nvtAeropuerto.inmovables[47].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[48]" ng-click="nvtAeropuerto.showPropertyData(6, '8E', nvtAeropuerto.inmovables[48].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[49]" ng-click="nvtAeropuerto.showPropertyData(6, '9E', nvtAeropuerto.inmovables[49].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[50]" ng-click="nvtAeropuerto.showPropertyData(6, '10E', nvtAeropuerto.inmovables[50].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[51]" ng-click="nvtAeropuerto.showPropertyData(6, '11E', nvtAeropuerto.inmovables[51].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[52]" ng-click="nvtAeropuerto.showPropertyData(6, '12E', nvtAeropuerto.inmovables[52].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[53]" ng-click="nvtAeropuerto.showPropertyData(6, '13E', nvtAeropuerto.inmovables[53].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[54]" ng-click="nvtAeropuerto.showPropertyData(6, '14E', nvtAeropuerto.inmovables[54].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[55]" ng-click="nvtAeropuerto.showPropertyData(6, '15E', nvtAeropuerto.inmovables[55].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[56]" ng-click="nvtAeropuerto.showPropertyData(6, '16E', nvtAeropuerto.inmovables[56].idProperty)">
					...
					<g ng-class="nvtAeropuerto.inmovablesClassList[57]" ng-click="nvtAeropuerto.showPropertyData(6, '17E', nvtAeropuerto.inmovables[57].idProperty)">
