		...
		<div class="container-dialog p-20">
			...
			<div class="content-dialog">
				...
				<div class="p-20 grey lighten-5">
					...
					<div class="p-5">
						<h6 class="futura-med">Navetec Business Park San Luis Potosi 3</h6>
					</div>
					<div class="p-5">
					...
					<div class="p-20">
						<h6 class="deep-purple-text futura-light">{{nvtSLP.propertyData.discountPlan2}}% de descuento para propiedades con financiamiento hasta 48 Meses</h6>
	...
	<div class="plano_container">
		...
		<div class="container mt-64">
			<div class="row quote-header">
				<div class="col s12">
					<h2 class="center-align futura-med">SAN LUIS POTOSÍ 3</h2>
        ...
        <svg version="1.1" class="quote__map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
			...
			<g id="MODULO_A">
				<g ng-class="nvtSLP.inmovablesClassList[15]" ng-click="nvtSLP.showPropertyData(26, '16A', nvtSLP.inmovables[15].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[16]" ng-click="nvtSLP.showPropertyData(26, '17A', nvtSLP.inmovables[16].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[17]" ng-click="nvtSLP.showPropertyData(26, '18A', nvtSLP.inmovables[17].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[18]" ng-click="nvtSLP.showPropertyData(26, '19A', nvtSLP.inmovables[18].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[19]" ng-click="nvtSLP.showPropertyData(26, '20A', nvtSLP.inmovables[19].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[20]" ng-click="nvtSLP.showPropertyData(26, '21A', nvtSLP.inmovables[20].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[21]" ng-click="nvtSLP.showPropertyData(26, '22A', nvtSLP.inmovables[21].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[22]" ng-click="nvtSLP.showPropertyData(26, '23A', nvtSLP.inmovables[22].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[23]" ng-click="nvtSLP.showPropertyData(26, '24A', nvtSLP.inmovables[23].idProperty)">
			...
			<g id="MODULO_G">
				<g ng-class="nvtSLP.inmovablesClassList[80]" ng-click="nvtSLP.showPropertyData(26, '1G', nvtSLP.inmovables[80].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[81]" ng-click="nvtSLP.showPropertyData(26, '2G', nvtSLP.inmovables[81].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[82]" ng-click="nvtSLP.showPropertyData(26, '3G', nvtSLP.inmovables[82].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[83]" ng-click="nvtSLP.showPropertyData(26, '4G', nvtSLP.inmovables[83].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[84]" ng-click="nvtSLP.showPropertyData(26, '5G', nvtSLP.inmovables[84].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[85]" ng-click="nvtSLP.showPropertyData(26, '6G', nvtSLP.inmovables[85].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[86]" ng-click="nvtSLP.showPropertyData(26, '7G', nvtSLP.inmovables[86].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[87]" ng-click="nvtSLP.showPropertyData(26, '8G', nvtSLP.inmovables[87].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[88]" ng-click="nvtSLP.showPropertyData(26, '9G', nvtSLP.inmovables[88].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[89]" ng-click="nvtSLP.showPropertyData(26, '10G', nvtSLP.inmovables[89].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[90]" ng-click="nvtSLP.showPropertyData(26, '11G', nvtSLP.inmovables[90].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[91]" ng-click="nvtSLP.showPropertyData(26, '12G', nvtSLP.inmovables[91].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[92]" ng-click="nvtSLP.showPropertyData(26, '13G', nvtSLP.inmovables[92].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[93]" ng-click="nvtSLP.showPropertyData(26, '14G', nvtSLP.inmovables[93].idProperty)">
			...
			<g id="MODULO_H">
				<g ng-class="nvtSLP.inmovablesClassList[94]" ng-click="nvtSLP.showPropertyData(26, '1H', nvtSLP.inmovables[94].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[95]" ng-click="nvtSLP.showPropertyData(26, '2H', nvtSLP.inmovables[95].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[96]" ng-click="nvtSLP.showPropertyData(26, '3H', nvtSLP.inmovables[96].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[97]" ng-click="nvtSLP.showPropertyData(26, '4H', nvtSLP.inmovables[97].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[98]" ng-click="nvtSLP.showPropertyData(26, '5H', nvtSLP.inmovables[98].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[99]" ng-click="nvtSLP.showPropertyData(26, '6H', nvtSLP.inmovables[99].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[100]" ng-click="nvtSLP.showPropertyData(26, '7H', nvtSLP.inmovables[100].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[101]" ng-click="nvtSLP.showPropertyData(26, '8H', nvtSLP.inmovables[101].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[102]" ng-click="nvtSLP.showPropertyData(26, '9H', nvtSLP.inmovables[102].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[103]" ng-click="nvtSLP.showPropertyData(26, '10H', nvtSLP.inmovables[103].idProperty)">
			...
			<g id="MODULO_I">
				<g ng-class="nvtSLP.inmovablesClassList[104]" ng-click="nvtSLP.showPropertyData(26, '1I', nvtSLP.inmovables[104].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[105]" ng-click="nvtSLP.showPropertyData(26, '2I', nvtSLP.inmovables[105].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[106]" ng-click="nvtSLP.showPropertyData(26, '3I', nvtSLP.inmovables[106].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[107]" ng-click="nvtSLP.showPropertyData(26, '4I', nvtSLP.inmovables[107].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[108]" ng-click="nvtSLP.showPropertyData(26, '5I', nvtSLP.inmovables[108].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[109]" ng-click="nvtSLP.showPropertyData(26, '6I', nvtSLP.inmovables[109].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[110]" ng-click="nvtSLP.showPropertyData(26, '7I', nvtSLP.inmovables[110].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[111]" ng-click="nvtSLP.showPropertyData(26, '8I', nvtSLP.inmovables[111].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[112]" ng-click="nvtSLP.showPropertyData(26, '9I', nvtSLP.inmovables[112].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[113]" ng-click="nvtSLP.showPropertyData(26, '10I', nvtSLP.inmovables[113].idProperty)">
				...
				<g ng-class="nvtSLP.inmovablesClassList[114]" ng-click="nvtSLP.showPropertyData(26, '11I', nvtSLP.inmovables[114].idProperty)">
