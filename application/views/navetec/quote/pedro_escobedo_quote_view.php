...
<body ng-controller="NvtPedroEscobedoQuoteCtrl as nvtPedroEscobedo">
	...
	<div class="modal-dialog" ng-class="nvtPedroEscobedo.dialogDisplay">
        ...
        <div class="p-20 grey lighten-5">
          <div class="p-5">
            <h6 class="futura-med">Navetec Business Park {{nvtPedroEscobedo.propertyData.condominium}}</h6>
          </div>
          <div class="p-5">
						<h6 class="futura-light">{{nvtPedroEscobedo.propertyData.propertyClass}}</h6>
					</div>
          <div class="p-5">
            <h6 class="futura-light">{{nvtPedroEscobedo.propertyData.type}}</h6>
          </div>
          <div class="p-5">
            <h6 class="futura-light">Número {{nvtPedroEscobedo.propertyData.number}}</h6>
          </div>
          <!-- <div class="p-5">
            <h6 class="futura-light">Dimenciones: {{nvtPedroEscobedo.propertyData.dimensions}}</h6>
          </div> -->
          <div class="p-5">
            <h6 class="futura-light">Área de {{nvtPedroEscobedo.propertyData.area}} M&sup2;</h6>
          </div>
          <div class="p-5">
            <h6 class="futura-light">Precio por M&sup2; de ${{nvtPedroEscobedo.propertyData.cost_m2}} MXN</h6>
          </div>
          <div class="p-5">
            <h6 class="futura-light green-text">Precio de ${{nvtPedroEscobedo.propertyData.total}} MXN <span style="color: #857C82; font-size: 12px;"></span></h6>
          </div>
          <div class="p-5">
        ...
        <div class="p-20">
          <h6 class="deep-purple-text futura-light">{{nvtPedroEscobedo.propertyData.discountPlan1}}% para propiedades pagadas de contado al 100%</h6>
          <h6 class="green-text futura-light">Precio de ${{nvtPedroEscobedo.propertyData.totalPlan1}} MXN <span style="color: #857C82; font-size: 12px;">+ I.V.A.</span></h6>
        ...
        <div class="p-20">
          <h6 class="deep-purple-text futura-light">{{nvtPedroEscobedo.propertyData.discountPlan2}}% de descuento para propiedades con financiamiento hasta 10 años</h6>
          <h6 class="green-text futura-light">Precio de ${{nvtPedroEscobedo.propertyData.totalPlan2}} MXN</h6>
          <p class="promo__description grey-text">¡Oferta limitada!</p>
        </div> -->
        ...
        <div class="p-20">
          ...
          <p class="promo__description grey-text">*Valido hasta {{nvtPedroEscobedo.month + ' ' + nvtPedroEscobedo.year}}</p>
        </div>
        ...
        <div class="divider"></div>
				...
				<div class="p-20">
					...
					<p class="green-text">Con tan solo {{nvtPedroEscobedo.costToBlock}}</p>
	...
	<div class="plano_container">
		...
		<div class="container mt-64">
			<div class="row quote-header">
				<div class="col s12">
					<h2 class="center-align futura-med">PEDRO ESCOBEDO</h2>
    ...
    <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
      ...
      <g id="ships">
        <g id="isla-a">
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[0]" ng-click="nvtPedroEscobedo.showPropertyData(15, '1A', nvtPedroEscobedo.inmovables[0].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[1]" ng-click="nvtPedroEscobedo.showPropertyData(15, '2A', nvtPedroEscobedo.inmovables[1].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[2]" ng-click="nvtPedroEscobedo.showPropertyData(15, '3A', nvtPedroEscobedo.inmovables[2].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[3]" ng-click="nvtPedroEscobedo.showPropertyData(15, '4A', nvtPedroEscobedo.inmovables[3].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[4]" ng-click="nvtPedroEscobedo.showPropertyData(15, '5A', nvtPedroEscobedo.inmovables[4].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[5]" ng-click="nvtPedroEscobedo.showPropertyData(15, '6A', nvtPedroEscobedo.inmovables[5].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[6]" ng-click="nvtPedroEscobedo.showPropertyData(15, '7A', nvtPedroEscobedo.inmovables[6].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[7]" ng-click="nvtPedroEscobedo.showPropertyData(15, '8A', nvtPedroEscobedo.inmovables[7].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[8]" ng-click="nvtPedroEscobedo.showPropertyData(15, '9A', nvtPedroEscobedo.inmovables[8].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[9]" ng-click="nvtPedroEscobedo.showPropertyData(15, '10A', nvtPedroEscobedo.inmovables[9].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[10]" ng-click="nvtPedroEscobedo.showPropertyData(15, '11A', nvtPedroEscobedo.inmovables[10].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[11]" ng-click="nvtPedroEscobedo.showPropertyData(15, '12A', nvtPedroEscobedo.inmovables[11].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[12]" ng-click="nvtPedroEscobedo.showPropertyData(15, '13A', nvtPedroEscobedo.inmovables[12].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[13]" ng-click="nvtPedroEscobedo.showPropertyData(15, '14A', nvtPedroEscobedo.inmovables[13].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[14]" ng-click="nvtPedroEscobedo.showPropertyData(15, '15A', nvtPedroEscobedo.inmovables[14].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[15]" ng-click="nvtPedroEscobedo.showPropertyData(15, '16A', nvtPedroEscobedo.inmovables[15].idProperty)">
        ...
        <g id="isla-b">
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[16]" ng-click="nvtPedroEscobedo.showPropertyData(15, '1B', nvtPedroEscobedo.inmovables[16].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[17]" ng-click="nvtPedroEscobedo.showPropertyData(15, '2B', nvtPedroEscobedo.inmovables[17].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[18]" ng-click="nvtPedroEscobedo.showPropertyData(15, '3B', nvtPedroEscobedo.inmovables[18].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[19]" ng-click="nvtPedroEscobedo.showPropertyData(15, '4B', nvtPedroEscobedo.inmovables[19].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[20]" ng-click="nvtPedroEscobedo.showPropertyData(15, '5B', nvtPedroEscobedo.inmovables[20].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[21]" ng-click="nvtPedroEscobedo.showPropertyData(15, '6B', nvtPedroEscobedo.inmovables[21].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[22]" ng-click="nvtPedroEscobedo.showPropertyData(15, '7B', nvtPedroEscobedo.inmovables[22].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[23]" ng-click="nvtPedroEscobedo.showPropertyData(15, '8B', nvtPedroEscobedo.inmovables[23].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[24]" ng-click="nvtPedroEscobedo.showPropertyData(15, '9B', nvtPedroEscobedo.inmovables[24].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[25]" ng-click="nvtPedroEscobedo.showPropertyData(15, '10B', nvtPedroEscobedo.inmovables[25].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[26]" ng-click="nvtPedroEscobedo.showPropertyData(15, '11B', nvtPedroEscobedo.inmovables[26].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[27]" ng-click="nvtPedroEscobedo.showPropertyData(15, '12B', nvtPedroEscobedo.inmovables[27].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[28]" ng-click="nvtPedroEscobedo.showPropertyData(15, '13B', nvtPedroEscobedo.inmovables[28].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[29]" ng-click="nvtPedroEscobedo.showPropertyData(15, '14B', nvtPedroEscobedo.inmovables[29].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[30]" ng-click="nvtPedroEscobedo.showPropertyData(15, '15B', nvtPedroEscobedo.inmovables[30].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[31]" ng-click="nvtPedroEscobedo.showPropertyData(15, '16B', nvtPedroEscobedo.inmovables[31].idProperty)">
        ...
        <g id="isla-c">
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[32]" ng-click="nvtPedroEscobedo.showPropertyData(15, '1C', nvtPedroEscobedo.inmovables[32].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[33]" ng-click="nvtPedroEscobedo.showPropertyData(15, '2C', nvtPedroEscobedo.inmovables[33].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[34]" ng-click="nvtPedroEscobedo.showPropertyData(15, '3C', nvtPedroEscobedo.inmovables[34].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[35]" ng-click="nvtPedroEscobedo.showPropertyData(15, '4C', nvtPedroEscobedo.inmovables[35].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[36]" ng-click="nvtPedroEscobedo.showPropertyData(15, '5C', nvtPedroEscobedo.inmovables[36].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[37]" ng-click="nvtPedroEscobedo.showPropertyData(15, '6C', nvtPedroEscobedo.inmovables[37].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[38]" ng-click="nvtPedroEscobedo.showPropertyData(15, '7C', nvtPedroEscobedo.inmovables[38].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[39]" ng-click="nvtPedroEscobedo.showPropertyData(15, '8C', nvtPedroEscobedo.inmovables[39].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[40]" ng-click="nvtPedroEscobedo.showPropertyData(15, '9C', nvtPedroEscobedo.inmovables[40].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[41]" ng-click="nvtPedroEscobedo.showPropertyData(15, '10C', nvtPedroEscobedo.inmovables[41].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[42]" ng-click="nvtPedroEscobedo.showPropertyData(15, '11C', nvtPedroEscobedo.inmovables[42].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[43]" ng-click="nvtPedroEscobedo.showPropertyData(15, '12C', nvtPedroEscobedo.inmovables[43].idProperty)">
        ...
        <g id="isla-d">
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[44]" ng-click="nvtPedroEscobedo.showPropertyData(15, '1D', nvtPedroEscobedo.inmovables[44].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[45]" ng-click="nvtPedroEscobedo.showPropertyData(15, '2D', nvtPedroEscobedo.inmovables[45].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[46]" ng-click="nvtPedroEscobedo.showPropertyData(15, '3D', nvtPedroEscobedo.inmovables[46].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[47]" ng-click="nvtPedroEscobedo.showPropertyData(15, '4D', nvtPedroEscobedo.inmovables[47].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[48]" ng-click="nvtPedroEscobedo.showPropertyData(15, '5D', nvtPedroEscobedo.inmovables[48].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[49]" ng-click="nvtPedroEscobedo.showPropertyData(15, '6D', nvtPedroEscobedo.inmovables[49].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[50]" ng-click="nvtPedroEscobedo.showPropertyData(15, '7D', nvtPedroEscobedo.inmovables[50].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[51]" ng-click="nvtPedroEscobedo.showPropertyData(15, '8D', nvtPedroEscobedo.inmovables[51].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[52]" ng-click="nvtPedroEscobedo.showPropertyData(15, '9D', nvtPedroEscobedo.inmovables[52].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[53]" ng-click="nvtPedroEscobedo.showPropertyData(15, '10D', nvtPedroEscobedo.inmovables[53].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[54]" ng-click="nvtPedroEscobedo.showPropertyData(15, '11D', nvtPedroEscobedo.inmovables[54].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[55]" ng-click="nvtPedroEscobedo.showPropertyData(15, '12D', nvtPedroEscobedo.inmovables[55].idProperty)">
        ...
        <g id="isla-e">
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[56]" ng-click="nvtPedroEscobedo.showPropertyData(15, '1E', nvtPedroEscobedo.inmovables[56].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[57]" ng-click="nvtPedroEscobedo.showPropertyData(15, '2E', nvtPedroEscobedo.inmovables[57].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[58]" ng-click="nvtPedroEscobedo.showPropertyData(15, '3E', nvtPedroEscobedo.inmovables[58].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[59]" ng-click="nvtPedroEscobedo.showPropertyData(15, '4E', nvtPedroEscobedo.inmovables[59].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[60]" ng-click="nvtPedroEscobedo.showPropertyData(15, '5E', nvtPedroEscobedo.inmovables[60].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[61]" ng-click="nvtPedroEscobedo.showPropertyData(15, '6E', nvtPedroEscobedo.inmovables[61].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[62]" ng-click="nvtPedroEscobedo.showPropertyData(15, '7E', nvtPedroEscobedo.inmovables[62].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[63]" ng-click="nvtPedroEscobedo.showPropertyData(15, '8E', nvtPedroEscobedo.inmovables[63].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[64]" ng-click="nvtPedroEscobedo.showPropertyData(15, '9E', nvtPedroEscobedo.inmovables[64].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[65]" ng-click="nvtPedroEscobedo.showPropertyData(15, '10E', nvtPedroEscobedo.inmovables[65].idProperty)">
        ...
        <g id="isla-f">
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[66]" ng-click="nvtPedroEscobedo.showPropertyData(15, '1F', nvtPedroEscobedo.inmovables[66].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[67]" ng-click="nvtPedroEscobedo.showPropertyData(15, '2F', nvtPedroEscobedo.inmovables[67].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[68]" ng-click="nvtPedroEscobedo.showPropertyData(15, '3F', nvtPedroEscobedo.inmovables[68].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[69]" ng-click="nvtPedroEscobedo.showPropertyData(15, '4F', nvtPedroEscobedo.inmovables[69].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[70]" ng-click="nvtPedroEscobedo.showPropertyData(15, '5F', nvtPedroEscobedo.inmovables[70].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[71]" ng-click="nvtPedroEscobedo.showPropertyData(15, '6F', nvtPedroEscobedo.inmovables[71].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[72]" ng-click="nvtPedroEscobedo.showPropertyData(15, '7F', nvtPedroEscobedo.inmovables[72].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[73]" ng-click="nvtPedroEscobedo.showPropertyData(15, '8F', nvtPedroEscobedo.inmovables[73].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[74]" ng-click="nvtPedroEscobedo.showPropertyData(15, '9F', nvtPedroEscobedo.inmovables[74].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[75]" ng-click="nvtPedroEscobedo.showPropertyData(15, '10F', nvtPedroEscobedo.inmovables[75].idProperty)">
        ...
        <g id="isla-g">
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[76]" ng-click="nvtPedroEscobedo.showPropertyData(15, '1G', nvtPedroEscobedo.inmovables[76].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[77]" ng-click="nvtPedroEscobedo.showPropertyData(15, '2G', nvtPedroEscobedo.inmovables[77].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[78]" ng-click="nvtPedroEscobedo.showPropertyData(15, '3G', nvtPedroEscobedo.inmovables[78].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[79]" ng-click="nvtPedroEscobedo.showPropertyData(15, '4G', nvtPedroEscobedo.inmovables[79].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[80]" ng-click="nvtPedroEscobedo.showPropertyData(15, '5G', nvtPedroEscobedo.inmovables[80].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[81]" ng-click="nvtPedroEscobedo.showPropertyData(15, '6G', nvtPedroEscobedo.inmovables[81].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[82]" ng-click="nvtPedroEscobedo.showPropertyData(15, '7G', nvtPedroEscobedo.inmovables[82].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[83]" ng-click="nvtPedroEscobedo.showPropertyData(15, '8G', nvtPedroEscobedo.inmovables[83].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[84]" ng-click="nvtPedroEscobedo.showPropertyData(15, '9G', nvtPedroEscobedo.inmovables[84].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[85]" ng-click="nvtPedroEscobedo.showPropertyData(15, '10G', nvtPedroEscobedo.inmovables[85].idProperty)">
          ...
          <g ng-class="nvtPedroEscobedo.inmovablesClassList[86]" ng-click="nvtPedroEscobedo.showPropertyData(15, '11G', nvtPedroEscobedo.inmovables[86].idProperty)">
