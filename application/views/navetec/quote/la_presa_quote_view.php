...
<body ng-controller="NvtLaPresaQuoteCtrl as nvtLaPresa">
	...
	<md-sidenav class="cc-sidenav md-sidenav-left md-whiteframe-4dp" md-component-id="left">
        ...
        <md-divider></md-divider>
        <a href="#!/Navetec-La_Presa_Business_Park" ng-click="close()">
            <div class="link-body link-nav">
                La Presa Business Park
            </div>
        </a>
        <md-divider></md-divider>
	...
	<div class="modal-dialog" ng-class="nvtLaPresa.dialogDisplay">
        ...
        <div class="p-20 grey lighten-5">
          <div class="p-5">
            <h6 class="futura-med">Navetec Business Park {{nvtLaPresa.propertyData.condominium}}</h6>
          </div>
          <div class="p-5">
            <h6 class="futura-light">{{nvtLaPresa.propertyData.propertyClass}}</h6>
          </div>
          <div class="p-5">
            <h6 class="futura-light">{{nvtLaPresa.propertyData.type}}</h6>
          </div>
          <div class="p-5">
            <h6 class="futura-light">Número {{nvtLaPresa.propertyData.number}}</h6>
          </div>
          <!-- <div class="p-5">
            <h6 class="futura-light">Dimenciones: {{nvtLaPresa.propertyData.dimensions}}</h6>
          </div> -->
          <div class="p-5">
            <h6 class="futura-light">Área de {{nvtLaPresa.propertyData.area}} M&sup2;</h6>
          </div>
          <div class="p-5">
            <h6 class="futura-light">Precio por M&sup2; de ${{nvtLaPresa.propertyData.cost_m2}} MXN</h6>
          </div>
          <div class="p-5">
            <h6 class="futura-light green-text">Precio de ${{nvtLaPresa.propertyData.total}} MXN <span style="color: #857C82; font-size: 12px;">+ I.V.A.</span></h6>
          </div>
          <div class="p-5">
        ...
        <div class="p-20">
          <h6 class="deep-purple-text futura-light">{{nvtLaPresa.propertyData.discountPlan1}}% para propiedades pagadas de contado al 100%</h6>
          <h6 class="green-text futura-light">Precio de ${{nvtLaPresa.propertyData.totalPlan1}} MXN <span style="color: #857C82; font-size: 12px;">+ I.V.A.</span></h6>
        ...
        <div class="p-20">
          <h6 class="deep-purple-text futura-light">{{nvtLaPresa.propertyData.discountPlan2}}% de descuento para propiedades con financiamiento hasta 10 años</h6>
          <h6 class="green-text futura-light">Precio de ${{nvtLaPresa.propertyData.totalPlan2}} MXN <span style="color: #857C82; font-size: 12px;">+ I.V.A.</span></h6>
          <p class="promo__description grey-text">¡Oferta limitada!</p>
        </div> -->
        ...
        <div class="p-20">
          ...
          <p class="promo__description grey-text">*Valido hasta {{nvtLaPresa.month + ' ' + nvtLaPresa.year}}</p>
				</div>
				
				<div class="divider"></div>

				<div class="p-20">
					<h6 class="deep-purple-text futura-light">Compra en {{nvtLaPresa.month}} y paga la primera mensualidad hasta {{nvtLaPresa.nextMonth}}</h6>
					<p class="promo__description grey-text">*Pagando el 100% de enganche</p>
					<p class="promo__description grey-text">*Aplica para todas las operaciones a crédito realizadas en {{nvtLaPresa.month + ' ' + nvtLaPresa.year}}</p>
        </div>
        ...
        <div class="divider"></div>
				...
				<div class="p-20">
					...
					<p class="green-text">Con tan solo {{nvtLaPresa.costToBlock}}</p>
	...
	<div class="plano_container">
		...
		<div class="container mt-64">
			<div class="row quote-header">
				<div class="col s12">
					<h2 class="center-align futura-med">LA PRESA</h2>
    ...
    <svg version="1.1" class="quote__map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      ...
      <g id="islas_la_presa">
        <g id="isla_a">
          <g ng-class="nvtLaPresa.inmovablesClassList[0]" ng-click="nvtLaPresa.showPropertyData(16, '1A', nvtLaPresa.inmovables[0].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[1]" ng-click="nvtLaPresa.showPropertyData(16, '2A', nvtLaPresa.inmovables[1].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[2]" ng-click="nvtLaPresa.showPropertyData(16, '3A', nvtLaPresa.inmovables[2].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[3]" ng-click="nvtLaPresa.showPropertyData(16, '4A', nvtLaPresa.inmovables[3].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[4]" ng-click="nvtLaPresa.showPropertyData(16, '5A', nvtLaPresa.inmovables[4].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[5]" ng-click="nvtLaPresa.showPropertyData(16, '6A', nvtLaPresa.inmovables[5].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[6]" ng-click="nvtLaPresa.showPropertyData(16, '7A', nvtLaPresa.inmovables[6].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[7]" ng-click="nvtLaPresa.showPropertyData(16, '8A', nvtLaPresa.inmovables[7].idProperty)">
            ...
            <text transform="matrix(0.9999 -9.999500e-03 9.999500e-03 0.9999 43.1894 881.5624)" class="st6 futura-light st8">LOTE 8A</text>
          </g>
          <g ng-class="nvtLaPresa.inmovablesClassList[8]" ng-click="nvtLaPresa.showPropertyData(16, '9A', nvtLaPresa.inmovables[8].idProperty)">
            ...
            <text transform="matrix(0.9999 -9.999500e-03 9.999500e-03 0.9999 43.1893 948.3528)" class="st6 futura-light st8">LOTE 9A</text>
          </g>
          <g ng-class="nvtLaPresa.inmovablesClassList[9]" ng-click="nvtLaPresa.showPropertyData(16, '10A', nvtLaPresa.inmovables[9].idProperty)">
            ...
            <text transform="matrix(0.9999 -9.999500e-03 9.999500e-03 0.9999 43.1892 1015.7332)" class="st6 futura-light st8">LOTE 10A</text>
          </g>
          <g ng-class="nvtLaPresa.inmovablesClassList[10]" ng-click="nvtLaPresa.showPropertyData(16, '11A', nvtLaPresa.inmovables[10].idProperty)">
            ...
            <text transform="matrix(0.9999 -9.999500e-03 9.999500e-03 0.9999 43.1891 1083.0129)" class="st6 futura-light st8">LOTE 11A</text>
          </g>
        </g>
        <g id="isla_b">
          <g ng-class="nvtLaPresa.inmovablesClassList[11]" ng-click="nvtLaPresa.showPropertyData(16, '1B', nvtLaPresa.inmovables[11].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[12]" ng-click="nvtLaPresa.showPropertyData(16, '2B', nvtLaPresa.inmovables[12].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[13]" ng-click="nvtLaPresa.showPropertyData(16, '3B', nvtLaPresa.inmovables[13].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[14]" ng-click="nvtLaPresa.showPropertyData(16, '4B', nvtLaPresa.inmovables[14].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[15]" ng-click="nvtLaPresa.showPropertyData(16, '5B', nvtLaPresa.inmovables[15].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[16]" ng-click="nvtLaPresa.showPropertyData(16, '6B', nvtLaPresa.inmovables[16].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[17]" ng-click="nvtLaPresa.showPropertyData(16, '7B', nvtLaPresa.inmovables[17].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[18]" ng-click="nvtLaPresa.showPropertyData(16, '8B', nvtLaPresa.inmovables[18].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[19]" ng-click="nvtLaPresa.showPropertyData(16, '9B', nvtLaPresa.inmovables[19].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[20]" ng-click="nvtLaPresa.showPropertyData(16, '10B', nvtLaPresa.inmovables[20].idProperty)">
            ...
            <text transform="matrix(0.9999 -9.999500e-03 9.999500e-03 0.9999 232.5191 857.5825)" class="st6 futura-light st8">LOTE 10B</text>
          </g>
          <g ng-class="nvtLaPresa.inmovablesClassList[21]" ng-click="nvtLaPresa.showPropertyData(16, '11B', nvtLaPresa.inmovables[21].idProperty)">
            ...
            <text transform="matrix(0.9999 -9.999500e-03 9.999500e-03 0.9999 232.5195 935.7524)" class="st6 futura-light st8">LOTE 11B</text>
          </g>
          <g ng-class="nvtLaPresa.inmovablesClassList[22]" ng-click="nvtLaPresa.showPropertyData(16, '12B', nvtLaPresa.inmovables[22].idProperty)">
            ...
            <text transform="matrix(0.9999 -9.999500e-03 9.999500e-03 0.9999 232.5195 1015.7325)" class="st6 futura-light st8">LOTE 12B</text>
          </g>
          <g ng-class="nvtLaPresa.inmovablesClassList[23]" ng-click="nvtLaPresa.showPropertyData(16, '13B', nvtLaPresa.inmovables[23].idProperty)">
            ...
            <text transform="matrix(0.9999 -9.999500e-03 9.999500e-03 0.9999 232.2894 1108.6926)" class="st6 futura-light st8">LOTE 13B</text>
          </g>
        </g>
        <g id="isla_c">
          <g ng-class="nvtLaPresa.inmovablesClassList[24]" ng-click="nvtLaPresa.showPropertyData(16, '1C', nvtLaPresa.inmovables[24].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[25]" ng-click="nvtLaPresa.showPropertyData(16, '2C', nvtLaPresa.inmovables[25].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[26]" ng-click="nvtLaPresa.showPropertyData(16, '3C', nvtLaPresa.inmovables[26].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[27]" ng-click="nvtLaPresa.showPropertyData(16, '4C', nvtLaPresa.inmovables[27].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[28]" ng-click="nvtLaPresa.showPropertyData(16, '5C', nvtLaPresa.inmovables[28].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[29]" ng-click="nvtLaPresa.showPropertyData(16, '6C', nvtLaPresa.inmovables[29].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[30]" ng-click="nvtLaPresa.showPropertyData(16, '7C', nvtLaPresa.inmovables[30].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[31]" ng-click="nvtLaPresa.showPropertyData(16, '8C', nvtLaPresa.inmovables[31].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[32]" ng-click="nvtLaPresa.showPropertyData(16, '9C', nvtLaPresa.inmovables[32].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[33]" ng-click="nvtLaPresa.showPropertyData(16, '10C', nvtLaPresa.inmovables[33].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[34]" ng-click="nvtLaPresa.showPropertyData(16, '11C', nvtLaPresa.inmovables[34].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[35]" ng-click="nvtLaPresa.showPropertyData(16, '12C', nvtLaPresa.inmovables[35].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[36]" ng-click="nvtLaPresa.showPropertyData(16, '13C', nvtLaPresa.inmovables[36].idProperty)">
        ...
        <g id="isla_d">
          <g ng-class="nvtLaPresa.inmovablesClassList[37]" ng-click="nvtLaPresa.showPropertyData(16, '1D', nvtLaPresa.inmovables[37].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[38]" ng-click="nvtLaPresa.showPropertyData(16, '2D', nvtLaPresa.inmovables[38].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[39]" ng-click="nvtLaPresa.showPropertyData(16, '3D', nvtLaPresa.inmovables[39].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[40]" ng-click="nvtLaPresa.showPropertyData(16, '4D', nvtLaPresa.inmovables[40].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[41]" ng-click="nvtLaPresa.showPropertyData(16, '5D', nvtLaPresa.inmovables[41].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[42]" ng-click="nvtLaPresa.showPropertyData(16, '6D', nvtLaPresa.inmovables[42].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[43]" ng-click="nvtLaPresa.showPropertyData(16, '7D', nvtLaPresa.inmovables[43].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[44]" ng-click="nvtLaPresa.showPropertyData(16, '8D', nvtLaPresa.inmovables[44].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[45]" ng-click="nvtLaPresa.showPropertyData(16, '9D', nvtLaPresa.inmovables[45].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[46]" ng-click="nvtLaPresa.showPropertyData(16, '10D', nvtLaPresa.inmovables[46].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[47]" ng-click="nvtLaPresa.showPropertyData(16, '11D', nvtLaPresa.inmovables[47].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[48]" ng-click="nvtLaPresa.showPropertyData(16, '12D', nvtLaPresa.inmovables[48].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[49]" ng-click="nvtLaPresa.showPropertyData(16, '13D', nvtLaPresa.inmovables[49].idProperty)">
        ...
        <g id="isla_e">
          <g ng-class="nvtLaPresa.inmovablesClassList[50]" ng-click="nvtLaPresa.showPropertyData(16, '1E', nvtLaPresa.inmovables[50].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[51]" ng-click="nvtLaPresa.showPropertyData(16, '2E', nvtLaPresa.inmovables[51].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[52]" ng-click="nvtLaPresa.showPropertyData(16, '3E', nvtLaPresa.inmovables[52].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[53]" ng-click="nvtLaPresa.showPropertyData(16, '4E', nvtLaPresa.inmovables[53].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[54]" ng-click="nvtLaPresa.showPropertyData(16, '5E', nvtLaPresa.inmovables[54].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[55]" ng-click="nvtLaPresa.showPropertyData(16, '6E', nvtLaPresa.inmovables[55].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[56]" ng-click="nvtLaPresa.showPropertyData(16, '7E', nvtLaPresa.inmovables[56].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[57]" ng-click="nvtLaPresa.showPropertyData(16, '8E', nvtLaPresa.inmovables[57].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[58]" ng-click="nvtLaPresa.showPropertyData(16, '9E', nvtLaPresa.inmovables[58].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[59]" ng-click="nvtLaPresa.showPropertyData(16, '10E', nvtLaPresa.inmovables[59].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[60]" ng-click="nvtLaPresa.showPropertyData(16, '11E', nvtLaPresa.inmovables[60].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[61]" ng-click="nvtLaPresa.showPropertyData(16, '12E', nvtLaPresa.inmovables[61].idProperty)">
        ...
        <g id="isla_f">
          <g ng-class="nvtLaPresa.inmovablesClassList[62]" ng-click="nvtLaPresa.showPropertyData(16, '1F', nvtLaPresa.inmovables[62].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[63]" ng-click="nvtLaPresa.showPropertyData(16, '2F', nvtLaPresa.inmovables[63].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[64]" ng-click="nvtLaPresa.showPropertyData(16, '3F', nvtLaPresa.inmovables[64].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[65]" ng-click="nvtLaPresa.showPropertyData(16, '4F', nvtLaPresa.inmovables[65].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[66]" ng-click="nvtLaPresa.showPropertyData(16, '5F', nvtLaPresa.inmovables[66].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[67]" ng-click="nvtLaPresa.showPropertyData(16, '6F', nvtLaPresa.inmovables[67].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[68]" ng-click="nvtLaPresa.showPropertyData(16, '7F', nvtLaPresa.inmovables[68].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[69]" ng-click="nvtLaPresa.showPropertyData(16, '8F', nvtLaPresa.inmovables[69].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[70]" ng-click="nvtLaPresa.showPropertyData(16, '9F', nvtLaPresa.inmovables[70].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[71]" ng-click="nvtLaPresa.showPropertyData(16, '10F', nvtLaPresa.inmovables[71].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[72]" ng-click="nvtLaPresa.showPropertyData(16, '11F', nvtLaPresa.inmovables[72].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[73]" ng-click="nvtLaPresa.showPropertyData(16, '12F', nvtLaPresa.inmovables[73].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[74]" ng-click="nvtLaPresa.showPropertyData(16, '13F', nvtLaPresa.inmovables[74].idProperty)">
          ...
          <g ng-class="nvtLaPresa.inmovablesClassList[75]" ng-click="nvtLaPresa.showPropertyData(16, '14F', nvtLaPresa.inmovables[75].idProperty)">
