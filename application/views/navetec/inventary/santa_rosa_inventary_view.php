...
<body ng-controller="NvtSantaRosaCtrl as nvtSantaRosa">
	...
	<div class="modal__panel" ng-class="nvtSantaRosa.nvtSantaRosaListDialogDisplay">
		<div class="container__panel">
			<div class="toolbar__panel blue-txt">
				<p>SANTA ROSA - Naves</p>
				<span class="close__panel" ng-click="nvtSantaRosa.closeNvtSantaRosaListDialog()"><i class="material-icons" style="margin:0;">close</i></span>
    		</div>
			<div class="content__panel">
				<ul class="saufth-collapsable">
					<li ng-repeat="property in nvtSantaRosa.inmovablesData.inmovables">
						<div class="collapsable__header" ng-click="">
							...
							<div class="blue-pb00__bg">
								<div class="p-20 pointer" class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[$index]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[$index])"></div>
							</div>
						</div>
					</li>
				</ul>
	...
	<div class="modal-dialog" ng-class="nvtSantaRosa.advisersDialogDisplay">
		<div class="backdrop-dialog" ng-click="nvtSantaRosa.closeAdvisersDialog()"></div>
		<div class="container-dialog p-20">
			<div class="toolbar-dialog blue-txt">
				Asosiar Lote
				<span ng-click="nvtSantaRosa.closeAdvisersDialog()">
					<img class="btn-close-dialog mt-4" src="media/assets/img/icons/close.svg">
				</span>
			</div>
			<div class="content-dialog">
				<p>{{nvtSantaRosa.propertyData.reference}}</p>
				<ul class="saufth-collapsable">
					<li ng-repeat="user in nvtSantaRosa.activeUsers" ng-if="user.idProfile > 1">
						<div class="saufth-collapsable-header" ng-click="nvtSantaRosa.selectUser(lead.idLead, $index)" ng-class="nvtSantaRosa.activeUsers[$index].collapsableHeaderClass">
						...
						<ul class="saufth-collapsable-body" ng-class="nvtSantaRosa.activeUsers[$index].collapsableBodyClass">
							<li class="saufth-collapsable-body-li" ng-repeat="lead in user.leads">
								<div class="saufth-collapsable-item-h" ng-click="nvtSantaRosa.selectLeadPropertyStatus(lead.idUser, lead.idLead)">
	...
	<div class="modal-dialog" ng-class="nvtSantaRosa.dialogStatusDisplay">
		<div class="backdrop-dialog" ng-click="nvtSantaRosa.closeDialogStatus()"></div>
		<div class="container-dialog p-20 status-dialog">
			<div class="toolbar-dialog blue-txt">
				Asosiar Lote
				<span ng-click="nvtSantaRosa.closeDialogStatus()">
					<img class="btn-close-dialog mt-4" src="media/assets/img/icons/close.svg">
				</span>
			</div>
			<div class="content-dialog">
				...
				<ul class="saufth-collapsable w100">
					<li>
						<div class="saufth-collapsable-header" ng-click="nvtSantaRosa.setStatus(1)"><div class="color-block pb-property-active-bg mr-15"></div>Disponible</div>
					</li>
					<li>
						<div class="saufth-collapsable-header" ng-click="nvtSantaRosa.setStatus(6)"><div class="color-block darkgray__bg mr-15"></div>Estratégico</div>
					</li>
					<li>
						<div class="saufth-collapsable-header" ng-click="nvtSantaRosa.setStatus(2)"><div class="color-block pb_lightred-bg mr-15"></div>En espera</div>
					</li>
					<li>
						<div class="saufth-collapsable-header" ng-click="nvtSantaRosa.setStatus(3)"><div class="color-block brown mr-15"></div>Apartado</div>
					</li>
					<li>
						<div class="saufth-collapsable-header" ng-click="nvtSantaRosa.setStatus(4)"><div class="color-block mustard-bg mr-15"></div>Enganchado</div>
					</li>
					<li>
						<div class="saufth-collapsable-header" ng-click="nvtSantaRosa.setStatus(5)"><div class="color-block pb_teal-bg mr-15"></div>Vendido</div>
					</li>
				</ul>
			</div>
		</div>
	...
	<!-- <div class="modal-dialog" ng-class="nvtSantaRosa.optionsDialogDisplay">
        <div class="backdrop-dialog" ng-click="nvtSantaRosa.closeOptionsDialogDisplay()"></div>
        <div class="container-s-dialog p-20">
            <div class="toolbar-dialog blue-txt">
                Opciones
                <span ng-click="nvtSantaRosa.closeOptionsDialogDisplay()">
                    <img class="btn-close-dialog mt-4" src="media/assets/img/icons/close.svg">
                </span>
            </div>
            <div class="content-dialog" style="overflow: initial;">
				<ul>
					<li><div class="btn-flat" ng-class="nvtSantaRosa.setLeadProperty()">Asignar cliente</div></li>
	...
	<div class="plano_container">
		...
		<div class="container mt-64">
			<div class="row quote-header">
				<div class="col s12">
					<h1 class="center-align">SANTA ROSA</h1>
		...
		<div class="container">
			...
			<div>
				<button class="btn-flat right"><i style="font-size:30px;" class="material-icons" ng-click="nvtSantaRosa.showInmovablesList()">list</i></button>
			</div>
		</div>
		...
		<svg version="1.1" class="quote__map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			...
			<g id="islas_santa_rosa">
				<g id="isla_a">
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[0]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[0])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[1]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[1])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[2]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[2])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[3]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[3])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[4]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[4])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[5]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[5])">
				...
				<g id="isla_b">
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[6]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[6])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[7]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[7])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[8]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[8])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[9]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[9])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[10]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[10])">
				...
				<g id="isla_c">
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[11]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[11])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[12]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[12])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[13]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[13])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[14]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[14])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[15]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[15])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[16]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[16])">
				...
				<g id="isla_d">
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[17]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[17])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[18]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[18])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[19]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[19])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[20]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[20])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[21]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[21])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[22]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[22])">
				...
				<g id="isla_e">
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[23]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[23])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[24]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[24])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[25]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[25])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[26]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[26])">
				...
				<g id="isla_f">
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[27]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[27])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[28]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[28])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[29]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[29])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[30]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[30])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[31]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[31])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[32]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[32])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[33]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[33])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[34]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[34])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[35]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[35])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[36]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[36])">
				...
				<g id="isla_g">
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[37]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[37])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[38]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[38])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[39]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[39])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[40]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[40])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[41]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[41])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[42]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[42])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[43]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[43])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[44]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[44])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[45]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[45])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[46]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[46])">
				...
				<g id="isla_h">
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[47]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[47])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[48]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[48])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[49]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[49])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[50]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[50])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[51]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[51])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[52]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[52])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[53]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[53])">
				...
				<g id="isla_i">
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[54]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[54])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[55]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[55])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[56]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[56])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[57]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[57])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[58]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[58])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[59]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[59])">
					...
					<g class="property__active" ng-class="nvtSantaRosa.inmovablesClassList[60]" ng-click="nvtSantaRosa.setLeadProperty(nvtSantaRosa.inmovablesData.inmovables[60])">
