    ...
    <div class="c-hero">
      <div class="row hero">
        <div class="col-12 cont-top">
          ...
          <md-button ng-click="landing.showDialog()" class="md-raised gradient__bg--blue py-2 ml-40 mt-24">
  ...
  <div class="container-fluid">
    ...
    <section id="clientes" class="seccion">
      ...
      <div class="row just-logos c-clientes">
        ...
        <div class="col-3 col-md-1 cliente-log" style="display: none">
    ...
    <!--FORMULARIO -->
        ...
        <div ng-class="landing.dialogDisplay"
          ...
          <div layout="column" layout-align="start center">
            ...
            <form class="py-40" name="newUserForm" layout="column" ng-submit="landing.sendLeadData(15)">
