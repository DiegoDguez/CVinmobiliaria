	...
	<div class="plano_container">
		...
		<div class="container mt-64">
			<div class="row quote-header">
				<div class="col s12">
					<h1 class="center-align">VEREDAS DE LIRA</h1>
		...
		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="vl-master_plan mt-64" viewBox="0 0 698.88 881.75">
			...
			<g>
				...
				<image width="6937" height="8930" transform="translate(6.41) scale(0.1)" xlink:href="media/assets/img/habitta/app/veredas_lira/veredas_lira-master_plan.png"/>
