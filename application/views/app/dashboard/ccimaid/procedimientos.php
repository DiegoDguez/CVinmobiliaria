...
<body ng-controller="DashboardCtrl as dashboard">
    ...
    <div class="container-fluid">
        <h5 class="blue-grey lighten-5 mt-20 p-10 text__center center-align">Politicas y Procedimientos</h5>
                    ...
                    <div class="border-box--blue border-r4 overflow-h">
                        ...
                        <div class="overflow-x-s overflow-y-s">
                            <div class="result-table-container">
                                <div class="border-box--blue-b px-5 py-10">
                                    <div layout="row" class="dark__text fs__14px proxima-soft-semibold">
                                       
                                        <div layout="row" flex="30" layout-align="left center" class="overflow-h pl-20">GENERALES</div>
                                ...
                                <div class="border-box--blue-b px-5 py-10">
                                    <div layout="row" class="dark__text fs__14px proxima-soft-semibold">
                                        <div layout="row" flex="30" layout-align="left center" class="overflow-h pl-20">CIRCULARES</div>
                                    </div>
                                </div>
                                <div class="border-box--blue-b px-5 py-10">
                                    <div layout="row" class="dark__text fs__14px proxima-soft-regular">
                                ...
                                <div class="border-box--blue-b px-5 py-10">
                                    <div layout="row" class="dark__text fs__14px proxima-soft-semibold">
                                        <div layout="row" flex="30" layout-align="left center" class="overflow-h pl-20">HÁBITTA</div>
                                    </div>
                                </div>
                                <div class="border-box--blue-b px-5 py-10">
                                    <div layout="row" class="dark__text fs__14px proxima-soft-regular">
                                ...
                                <div class="border-box--blue-b px-5 py-10">
                                    <div layout="row" class="dark__text fs__14px proxima-soft-semibold">
                                        <div layout="row" flex="30" layout-align="left center" class="overflow-h pl-20">NAVETEC</div>
                                    </div>
                                </div>
                                <div class="border-box--blue-b px-5 py-10">
                                    <div layout="row" class="dark__text fs__14px proxima-soft-regular">
