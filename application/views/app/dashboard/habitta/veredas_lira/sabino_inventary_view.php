...
<body ng-controller="VLSabinoCtrl as sabino">
...
<md-sidenav class="cc-sidenav md-sidenav-left md-whiteframe-4dp" md-component-id="left">
	...
	<div class="modal__panel" ng-class="sabino.sabinoListDialogDisplay">
		<div class="container__panel">
			<div class="toolbar__panel blue-txt">
				<p>Sabino - Lotes</p>
				<span class="close__panel" ng-click="sabino.closeSabinoListDialog()"><i class="material-icons" style="margin:0;">close</i></span>
			</div>
			<div class="content__panel">
				<ul class="saufth-collapsable">
					<li ng-repeat="property in sabino.inmovablesData.inmovables" ng-if="property.idCondominium === 5">
						<div class="collapsable__header" ng-click="">
							...
							<div class="blue-pb00__bg">
								<div class="p-20 pointer" class="property__active" ng-class="sabino.inmovablesClassList[$index]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[$index])"><$/div>
							</div>
						</div>
					</li>
				</ul>
	...
	<div class="modal-dialog" ng-class="sabino.dialogDisplay">
		<div class="backdrop-dialog" ng-click="sabino.closeDialog()"></div>
		<div class="container-dialog p-20">
			<div class="toolbar-dialog blue-txt">
				Asosiar Lote
				<span ng-click="sabino.closeDialog()">
					<img class="btn-close-dialog mt-4" src="media/assets/img/icons/close.svg">
				</span>
			</div>
			<div class="content-dialog">
				<p>{{sabino.propertyData.reference}}</p>
				<ul class="saufth-collapsable">
					<li ng-repeat="user in sabino.activeUsers" ng-if="user.idProfile > 1">
						<div class="saufth-collapsable-header" ng-click="sabino.selectUser(lead.idLead, $index)" ng-class="sabino.activeUsers[$index].collapsableHeaderClass">
						...
						<ul class="saufth-collapsable-body" ng-class="sabino.activeUsers[$index].collapsableBodyClass">
							<li class="saufth-collapsable-body-li" ng-repeat="lead in user.leads">
								<div class="saufth-collapsable-item-h" ng-click="sabino.selectLeadPropertyStatus(lead.idUser, lead.idLead)">
	...
	<div class="modal-dialog" ng-class="sabino.dialogStatusDisplay">
		<div class="backdrop-dialog" ng-click="sabino.closeDialogStatus()"></div>
		<div class="container-dialog p-20 status-dialog">
			<div class="toolbar-dialog blue-txt">
				Asosiar Lote
				<span ng-click="sabino.closeDialogStatus()">
					<img class="btn-close-dialog mt-4" src="media/assets/img/icons/close.svg">
				</span>
			</div>
			<div class="content-dialog">
				...
				<ul class="saufth-collapsable w100">
					<li>
						<div class="saufth-collapsable-header" ng-click="sabino.setStatus(1)"><div class="color-block pb-property-active-bg mr-15"></div>Disponible</div>
					</li>
					<li>
						<div class="saufth-collapsable-header" ng-click="sabino.setStatus(6)"><div class="color-block darkgray__bg mr-15"></div>Estratégico</div>
					</li>
					<li>
						<div class="saufth-collapsable-header" ng-click="sabino.setStatus(2)"><div class="color-block pb_lightred-bg mr-15"></div>En espera</div>
					</li>
					<li>
						<div class="saufth-collapsable-header" ng-click="sabino.setStatus(3)"><div class="color-block brown mr-15"></div>Apartado</div>
					</li>
					<li>
						<div class="saufth-collapsable-header" ng-click="sabino.setStatus(4)"><div class="color-block mustard-bg mr-15"></div>Enganchado</div>
					</li>
					<li>
						<div class="saufth-collapsable-header" ng-click="sabino.setStatus(5)"><div class="color-block pb_teal-bg mr-15"></div>Vendido</div>
					</li>
				</ul>
			</div>
		</div>
	...
	<div class="plano_container">
		...
		<div class="container mt-64">
			<div class="row portto_blanco-quote-header">
				<div class="col s12">
					<h1 class="center-align">CLUSTER SABINO</h1>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div>
				<button class="btn-flat right"><i style="font-size:30px;" class="material-icons" ng-click="sabino.showInmovablesList()">list</i></button>
			</div>
		</div>
		...
		<svg class="quote__map" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			...
			<g>
				<g>
					<g class="property__active" ng-class="sabino.inmovablesClassList[58]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[058])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[59]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[59])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[60]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[60])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[61]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[61])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[62]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[62])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[63]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[63])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[64]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[64])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[65]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[65])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[66]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[66])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[67]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[67])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[68]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[68])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[69]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[69])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[70]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[70])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[71]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[71])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[72]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[72])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[73]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[73])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[74]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[74])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[75]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[75])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[76]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[76])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[77]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[77])">
				...
				<g>
					<g class="property__active" ng-class="sabino.inmovablesClassList[78]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[78])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[79]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[79])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[80]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[80])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[81]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[81])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[82]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[82])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[83]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[83])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[84]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[84])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[85]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[85])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[86]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[86])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[87]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[87])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[88]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[88])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[89]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[89])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[90]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[90])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[91]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[91])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[92]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[92])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[93]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[93])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[94]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[94])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[95]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[95])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[96]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[96])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[97]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[97])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[98]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[98])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[99]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[99])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[100]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[100])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[101]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[101])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[102]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[102])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[103]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[103])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[104]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[104])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[105]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[105])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[106]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[106])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[107]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[107])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[108]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[108])">
				...
				<g>
					<g class="property__active" ng-class="sabino.inmovablesClassList[109]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[109])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[110]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[110])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[111]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[111])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[112]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[112])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[113]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[113])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[114]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[114])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[115]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[115])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[116]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[116])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[117]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[117])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[118]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[118])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[119]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[119])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[120]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[120])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[121]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[121])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[122]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[122])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[123]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[123])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[124]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[124])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[125]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[125])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[126]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[126])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[127]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[127])">
					...
					<g class="property__active" ng-class="sabino.inmovablesClassList[128]" ng-click="sabino.setLeadProperty(sabino.inmovablesData.inmovables[128])">
